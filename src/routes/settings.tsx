...
export const Route = createFileRoute("/settings")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Manage your profile, council preferences, and knowledge packs.",
      },
        ...
        <main className="mx-auto max-w-4xl px-6 py-10">
          ...
          <section className="mt-8 space-y-4">
            ...
            >
              {[
                {
                  l: "Auto-convene council on upload",
                  d: "Start research review as soon as a source is parsed.",
                },
                {
                  l: "Require ethics sign-off before export",
                  d: "Blocks publishing until trust score ≥ 80.",
                },
                {
                  l: "Include Cultural & Accessibility Advisor",
                  d: "Optional fifth expert on every session.",
                },
              ].map((s, i) => (
                <div
                  key={s.l}
              ...
              <div className="space-y-2">
                {knowledgePacks.map((k) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={cn("grid h-10 w-10 place-items-center rounded-lg", a.bg, a.text)}
                      >
